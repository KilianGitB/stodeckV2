 ...
 */
final class Version20221106104728 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, invoice_id INT NOT NULL, name VARCHAR(255) NOT NULL, date_added DATE NOT NULL, destocking_date DATE DEFAULT NULL, serial_number VARCHAR(255) NOT NULL, state TINYINT(1) NOT NULL, INDEX IDX_23A0E6612469DE2 (category_id), INDEX IDX_23A0E662989F1FD (invoice_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE invoice (id INT AUTO_INCREMENT NOT NULL, customer_id INT NOT NULL, name VARCHAR(255) NOT NULL, date DATE NOT NULL, INDEX IDX_906517449395C3F3 (customer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
